      ...
      {isLoading ? (
        ...
        <>
          <div className="fixed top-0 left-0 overflow-auto w-screen z-[999999999999] h-[100vh] bg-[#1B1928]">
            ...
            <div className="absolute top-1 right-1 flex gap-2 items-center laptop:hidden">
              <UILink
                href="/"
                name={<IoCloseCircleOutline className=" text-2xl" />}
                className="!text-red-color"
                onClick={handleCloseButtonClick}
              />
            </div>
            ...
            <div className="laptop:hidden">
              {!fullscreenMobile && (
                <div className="cursor-pointer" onClick={toggleFullscreen}>
                  <AiOutlineFullscreenExit className="text-3xl text-white absolute top-0 left-0 h-screen w-screen opacity-0" />
                </div>
              )}
            </div>
