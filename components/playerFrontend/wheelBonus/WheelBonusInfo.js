...
import SpinGame from "./SpinGame"; // Import the SpinGame component
...
const WheelBonusInfo = ({
  ...
  const wheelPrizeInfo = (number) => {
    const array = [
      ...
      "Congrats! You won 5 Free spins",
      "Try again in two hours",
      "Make a deposit to unlock the wheel for 20 days",
    ];
  ...
  return (
    <div>
      <Container>
        {/* Condition for users with deposit or after registration period */}
        ...
        {daysLeft === 0 ||
          (afterRegistration > 0 && (
            <div className="w-[600px] m-auto bg-bg-color1 shadow-lg rounded-3xl p-5 text-center">
              <div className="text-center !text-white p-4 prizeInfoContainer">
                <H4 name={t("unlock")} className="!text-white text-uppercase" />
        ...
        {remainingTime !== 0 && (
          <div className="relative">
            ...
            <div className="absolute top-0 left-0 w-full h-full flex items-center justify-center">
              <div className=" w-[600px] m-auto bg-gradient-to-r from-blue-color to-blue-600 shadow-2xl rounded-3xl p-5 text-center">
                <div className="text-center !text-white prizeInfoContainer">
                  <H4
                    name={`${wheelPrizeInfo(spinWinNumber ?? 12)}`}
                    className="!text-white"
                  />
                  <H4
                    name={`${wheelPrizeInfoText(spinWinNumber ?? 12)}`}
                    className="!text-white"
                  />
